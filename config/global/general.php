...
return array(
    ...
    // Meta
    'meta'    => array(
        'title'       => 'Automation of Marriage Licensing Process using Document Management Platform for Municipality of Bay, Laguna',
        'description' => 'This project aims to automate the marriage license application process for the Municipality of Bay, Laguna, through the use of a document management platform, improving the speed and accuracy of the process.',
        'keywords'    => 'Automation of Marriage Licensing Process using Document Management Platform for Municipality of Bay, Laguna, Laravel, bootstrap 5',

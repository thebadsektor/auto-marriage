                    ...
                    <div class="table-responsive">
                        <table class="table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="20">
                                        <p>City or Municipality of ______________________ Province of  _______________________________</p>

                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="20">
                                        <p>I, ____________________________, resident of _______________________, and {Father, Mother, Guardian, Person in charge} of _____________________________, resident of ________________________, single and less than {twenty, eighteen} years of age, being duly sworn, do hereby depose and say that I freely consent  to said ______________________, marrying with ______________________, resident of ______________________, and that I know of no legal impediment to such marriage.</p></td>
                                </tr>
                                <tr>
                                    <td colspan="20">
